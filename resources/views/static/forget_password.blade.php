        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <form action="{{route('site_post_forget_password')}}" method="post" id="formLogin">
                        @csrf
                        <input type="hidden" name="device_id" id="device_id">
                        <div class="input-group mb-3">
                            <input type="email" name="email" class="form-control" placeholder="{{Translate('البريد الإلكتروني')}}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block">{{Translate('ارسال')}}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
