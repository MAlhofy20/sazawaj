@extends('site.master')
@section('title') {{Translate('تقارير لوحة التحكم')}} @endsection
@section('style')
                            ...
                            @foreach ($data as $i=>$item)
                                <tr style="text-align: center">
                                    ...
                                    <div class="btn-action">
                                            <a href="#" class="btn btn-sm btn-danger" title="{{Translate('حذف')}}" onclick="deleteAdmin_report('{{ $item->id }}')"  data-toggle="modal" data-target="#confirm-del">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                    </div>
                                    </td>
