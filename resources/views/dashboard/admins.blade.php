...
@section('title') {{Translate('المديرين')}} @endsection
@section('style')
...
@section('modal')
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{Translate('إضافة مدير')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="edit-admin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{Translate('تعديل مدير')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{route('updateadmin')}}" id="updateAdminForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>{{Translate('الجوال')}}</label>
                    <input type="text" name="phone" id="edit_phone" class="form-control phone">
                </div>
                <div class="form-group">
                    <label>{{Translate('الصلاحية')}}</label>
