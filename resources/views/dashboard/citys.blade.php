                ...
                <div class="col-12">
                    <div class="btns header-buttons">
                        <button class="btn bg-teal" title="{{ Translate('اضافة') }}" data-toggle="modal"
                            data-target="#add-city">
                            <i class="fas fa-plus"></i>
                        </button>
                        <button class="btn btn-danger" onclick="deleteAllCity('more')" data-toggle="modal"
                        ...
                        <tbody>
                            @foreach ($data as $i => $item)
                                <tr style="text-align: center">
                                    ...
                                    {{-- <td>{{ ++$i }}</td> --}}
                                    <td>{{ $item->title_ar }}</td>
                                    {{-- <td><a href="{{ route('showcitydelivery', $item->id) }}"
                                            class="btn btn-info">{{ Translate('عرض') }}</a></td> --}}
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-action">
                                            <a href="#" class="btn btn-sm bg-teal" title="{{ Translate('تعديل') }}"
                                                onclick="editCity({{ $item }})" data-toggle="modal"
                                                data-target="#edit-city">
                                                <i class="fas fa-pen"></i>
                                            </a>

                                            <a href="#" class="btn btn-sm btn-danger" title="{{ Translate('حذف') }}"
                                                onclick="deleteCity('{{ $item->id }}')" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('addcity') }}" id="addCityForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" onclick="addCity()"
    ...
    <div class="modal fade" id="edit-city" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updatecity') }}" id="updateCityForm" method="POST"
