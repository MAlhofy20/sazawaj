            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="btns header-buttons">
                        <button class="btn bg-teal" title="{{Translate('اضافة')}}" data-toggle="modal" data-target="#add-country">
                            ...
                            @foreach ($data as $i=>$item)
                                <tr style="text-align: center">
                                    ...
                                    <div class="btn-action">
                                        <a href="#" class="btn btn-sm bg-teal" title="{{Translate('تعديل')}}" onclick="editCountry({{ $item }})"  data-toggle="modal" data-target="#edit-country">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('addcountry')}}" id="addCountryForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>{{Translate('رمز العملة')}}</label>
                    <input type="text" name="currency" class="form-control">
                </div>
                <div class="d-flex justify-content-center">
                    <button type="submit" onclick="addCountry()" class="btn btn-sm btn-success save">{{Translate('حفظ')}}</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('updatecountry')}}" id="updateCountryForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>{{Translate('كود الدولة')}}</label>
                    <input type="number" name="code" id="edit_code" class="form-control">
                </div>
                <div class="form-group">
                    <label>{{Translate('رمز العملة')}}</label>
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" onclick="updateCountry()" class="btn btn-sm btn-success save">{{Translate('حفظ')}}</button>
                    <button class="btn btn-sm btn-danger" data-dismiss="modal">{{Translate('إغلاق')}}</button>
                </div>
            </form>
          </div>
