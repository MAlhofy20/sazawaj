...
<html>
    <head>
        ...
        <title>{{settings('site_name')}} | {{Translate('تسجيل مندوب')}}</title>
        <!-- Font Awesome -->
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="{{route('site_home')}}"><b>{{settings('site_name')}}</b></a>
            </div>
            <!-- /.login-logo -->
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{settings('site_name')}} - {{Translate('تسجيل مندوب')}}</p>
                    ...
                    <form action="" method="post" id="formLogin">
                        ...
                        <div class="input-group mb-3" style="display: none">
                            <select name="user_type" id="" class="form-control" dir="rtl">
                                {{-- <option value="">- اختار نوع الخدمة -</option> --}}
                                {{--@foreach(show_user_types() as $key=>$item)
                                    <option value="{{$key}}" @if($user_type == $key) selected @endif>{{$item}}</option>
                                @endforeach--}}
                                <option value="provider">مندوب</option>
                            </select>
                        ...
                        <div class="input-group mb-3">
                            {{Translate('صورة السجل التجاري')}}
                        </div>
                        <div class="input-group mb-3">
                            <input class="form-control" type="file" name="id_photo" accept="image/*"/>
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-camera"></span>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="first_name" dir="rtl" class="form-control" placeholder="{{Translate('الاسم ')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-user"></span>
                                </div>
                        ...
                        {{-- <div class="input-group mb-3">
                            <input type="text" name="last_name" dir="rtl" class="form-control" placeholder="{{Translate('اسم العائلة')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-user"></span>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="email" name="email" dir="rtl" class="form-control" placeholder="{{Translate('البريد الإلكتروني')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        {{-- <div class="input-group mb-3">
                            <select name="phone_code" id="" class="form-control" dir="rtl">
                                <option value="">كود الجوال</option>
                                @foreach(App\Models\Country::orderBy('code')->get() as $country)
                        ...
                        <div class="input-group mb-3">
                            <input type="tel" name="phone" dir="rtl" class="form-control phone" placeholder="{{Translate('رقم الجوال')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-phone"></span>
                                </div>
                        ...
                        {{-- <div class="input-group mb-3">
                            <input type="text" name="address" dir="rtl" class="form-control" placeholder="{{Translate('العنوان ')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-globe"></span>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="password" name="password" dir="rtl" class="form-control" placeholder="{{Translate('كلمة المرور')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        {{--<div class="input-group mb-3">
                            <input type="password" name="password_confirmation" dir="rtl" class="form-control" placeholder="{{Translate('تأكيد كلمة المرور')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block login" onclick="login()">{{Translate('حفظ')}}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
