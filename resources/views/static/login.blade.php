...
<html>
    <head>
        ...
        <title>{{settings('site_name')}} | {{Translate('تسجيل الدخول')}}</title>
        <!-- Font Awesome -->
        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{settings('site_name')}} - {{Translate('تسجيل الدخول')}}</p>
                    ...
                    <form action="" method="post" id="formLogin">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" name="email" class="form-control" placeholder="{{Translate('البريد الإلكتروني')}}">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" name="password" class="form-control" placeholder="{{Translate('كلمة المرور')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block login" {{--onclick="login()"--}}>{{Translate('دخول')}}</button>
                            </div>
                            {{--<div class="col-6" style="margin-top: 5px;margin-bottom: 5px">
                                <a href="{{route('site_forget_password')}}" class="btn btn-info btn-block">{{Translate('نسيت كلمة المرور')}}</a>
                            </div>
                            <div class="col-6" style="margin-top: 5px;margin-bottom: 5px">
                                <a href="{{route('site_register')}}" class="btn btn-info btn-block">{{Translate('تسجيل جديد')}}</a>
                            </div>--}}
                            <!-- /.col -->
                        </div>
                    </form>
