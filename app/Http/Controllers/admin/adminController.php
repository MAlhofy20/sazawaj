...
class adminController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'first_name' => 'required|max:255|unique:users,first_name',
    ...
    public function update(Request $request)
    {
        ...
        if(empty($request->password)) $admin->update($request->except(['_token', 'photo','password']));
        else $admin->update($request->except(['_token', 'photo']));
