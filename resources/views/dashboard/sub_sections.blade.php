...
@section('title') {{ Translate('الاقسام الفرعية') }} @endsection
@section('style')
            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="btns header-buttons">
                        <button class="btn bg-teal" onclick="" title="{{ Translate('اضافة') }}" data-toggle="modal"
                        ...
                        <tbody>
                            @foreach ($data as $i => $item)
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <a href="{{ route('services', $item->id) }}" class="btn btn-info">
                                            عرض
                                            ({{ $item->services->count() }})
                                        </a>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('addsub_section') }}" id="addSectionForm" method="POST"
    ...
    <div class="modal fade" id="edit-section" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updatesub_section') }}" id="updateSectionForm" method="POST"
                        enctype="multipart/form-data">
                        @csrf
