                        ...
                        <tbody>
                            @foreach ($data as $i => $item)
                                <tr style="text-align: center">
                                    ...
                                    <td>{{ ++$i }}</td>
                                    {{--<td>
                                        <a data-fancybox data-caption="{{ $item->title_ar }}"
                                            href="{{ url('' . $item->image) }}">
                                    ...
                                    {{--<td>
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            ...
                                            <label class="custom-control-label" id="status_label{{$item->id}}" for="customSwitch{{$item->id}}">{{ $item->show ? Translate('اظهار') : Translate('اخفاء')}}</label>
                                        </div>
                                    </td>--}}
                                    <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('addsection') }}" id="addSectionForm" method="POST"
    ...
    <div class="modal fade" id="edit-section" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updatesection') }}" id="updateSectionForm" method="POST"
                        enctype="multipart/form-data">
                        @csrf
...
@section('script')
    <script>
        ...
        function editSection(section) {
            ...
            $('#edit_show_data').val(section.show_data);
            $('#edit_type').val(section.type);
            $('#edit_short_desc_ar').val(section.short_desc_ar);
            $('#edit_short_desc_en').val(section.short_desc_en);
            $('#edit_desc_ar').val(section.desc_ar);
            $('#edit_desc_en').val(section.desc_en);
