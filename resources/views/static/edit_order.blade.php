@extends('site.master')
@section('title') {{Translate('تعديل الطلب')}} @endsection
@section('style')
    <style>
        ...
        <div class="card" style="width:100% !important;">
            <div class="card-header">
                ...
                <div class="col-12 text-center">
                    ...
                    <p id="alertMsg" @if(count($cart) > 0) style="color: red;display:none" @else style="color: red" @endif>{{Translate('لا يوجد منتجات بالطلب')}}</p> 
                        ...
                        <table id="" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <form id="updateCartForm">
                                    ...
                                    <input type="hidden" name="order_item_id" id="cart_id">
