...
<html>
    <head>
        ...
        <title>{{settings('site_name')}} | {{Translate('تفعيل الحساب')}}</title>
        <!-- Font Awesome -->
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{settings('site_name')}} - {{Translate('تفعيل الحساب')}}</p>
                    ...
                    <form action="" method="post" id="formLogin">
                        ...
                        <div class="input-group mb-3">
                            <input type="tel" name="code" dir="rtl" class="form-control phone" placeholder="{{Translate('ادخل الكود المرسل الى جوالك')}}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block login" onclick="login()">{{Translate('تفعيل')}}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
        ...
        <script>
            ...
            var firebaseConfig = {
                apiKey: "AIzaSyDa9Tdn76MKhLqyTRVFfOW2voTPMd8lbBA",
                authDomain: "alomda-basha-dcc91.firebaseapp.com",
                databaseURL: "https://alomda-basha-dcc91.firebaseio.com",
                projectId: "alomda-basha-dcc91",
                storageBucket: "alomda-basha-dcc91.appspot.com",
                messagingSenderId: "312756082266",
                appId: "1:312756082266:web:2086ce2777fa68f35f6a63",
                measurementId: "G-CB79LWTZ0J"
            };
            // Initialize Firebase
            ...
            messaging.usePublicVapidKey("BK2_qLiPwwQqMLyTRePTCViobiYXyxWy5GNHZ1vuLe1uZPdi3uUVh_jSXS61t6CYIfQ7gYIP0iK-cBn7dIXsNJs");
