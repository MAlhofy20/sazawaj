...
<html>
    <head>
        ...
        <title>{{settings('site_name')}} | تسجيل الدخول</title>
        <!-- Font Awesome -->
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="{{url('/')}}"><b>{{settings('site_name')}}</b></a>
            </div>
            <!-- /.login-logo -->
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{settings('site_name')}} - تسجيل الدخول</p>
                    ...
                    <form action="" method="post" id="formLogin">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block login" onclick="login()">دخول</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
