                            ...
                            @foreach ($data as $i=>$item)
                                <tr style="text-align: center">
                                    ...
                                    <div class="btn-action">
                                        <a href="#" class="btn btn-sm bg-teal" title="{{Translate('تعديل')}}" onclick="editpage({{ $item }})"  data-toggle="modal" data-target="#edit-page">
          ...
          <div class="modal-body">
            <form action="{{route('addpage')}}" id="addpageForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" onclick="addpage()" class="btn btn-sm btn-success save">{{Translate('حفظ')}}</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('updatepage')}}" id="updatepageForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" onclick="updatepage()" class="btn btn-sm btn-success save">{{Translate('حفظ')}}</button>
                    <button class="btn btn-sm btn-danger" data-dismiss="modal">{{Translate('إغلاق')}}</button>
                </div>
            </form>
          </div>
