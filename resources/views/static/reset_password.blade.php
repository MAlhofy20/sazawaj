...
<html>
    <head>
        ...
        <title>{{settings('site_name')}} | {{Translate('استعادة كلمة المرور')}}</title>
        <!-- Font Awesome -->
        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{settings('site_name')}} - {{Translate('استعادة كلمة المرور')}}</p>

                    @include('msg')

                    <form action="{{route('site_post_reset_password')}}" method="post" id="formLogin">
                        @csrf
                        <input type="hidden" name="user_id" id="user_id" value="{{$user->id}}">
                        <div class="input-group mb-3">
                            <input type="tel" name="code" class="form-control phone" required placeholder="{{Translate('كود التحقق')}}">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" name="password" class="form-control" required placeholder="{{Translate('كلمة المرور')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block">{{Translate('حفظ')}}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
