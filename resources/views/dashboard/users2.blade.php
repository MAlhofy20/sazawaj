    ...
    <section class="content">
        <div class="search-div card  card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">{{Translate('البحث عن الأعضاء')}}</h3>
            </div>
            <div class="card-body">
                    ...
                    @foreach (get_users_by('client' , 'asc') as $item)
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <input type="checkbox" name="my-checkbox" {{$item->blocked ? '' : 'checked'}} data-bootstrap-switch data-on-text="{{Translate('نشط')}}"
                                    data-off-text="{{Translate('حظر')}}" data-off-color="danger" data-on-color="success">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <p class="text-muted text-sm"><b>{{Translate('البريد الألكتروني')}} : </b> {{ $item->email }}
                                        </p>
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> {{Translate('العنوان')}} :
                                            {{ $item->address }}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> {{Translate('الجوال')}} : {{ $item->phone }}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-clock"></i></span> {{Translate('تاريخ التسجيل')}} :
