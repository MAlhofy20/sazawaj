            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="btns header-buttons">
                        <button class="btn bg-teal" title="اضافة" data-toggle="modal" data-target="#add-service">
                            ...
                            @foreach ($data as $i=>$item)
                                <tr style="text-align: center">
                                    ...
                                    <div class="btn-action">
                                        <a href="#" class="btn btn-sm bg-teal" title="تعديل" onclick="editService({{ $item }})"  data-toggle="modal" data-target="#edit-service">
                                            <i class="fas fa-pen"></i>
                                        </a>

                                        <a href="#" class="btn btn-sm btn-danger" title="حذف" onclick="deleteService('{{ $item->id }}')"  data-toggle="modal" data-target="#confirm-del">
                                            <i class="fas fa-trash"></i>
                                        </a>
                                    </div>
                                    </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('addservice')}}" id="addServiceForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>التفاصيل القصيرة بالعربية</label>
                    <textarea name="short_desc_ar" class="form-control" rows="2"></textarea>
                </div>
                <div class="form-group">
                    <label>التفاصيل القصيرة بالإنجليزية</label>
