...
@section('title') {{Translate('تعديل صلاحية')}} @endsection
@section('style')
                ...
                <div class="table-responsive">
                    <form action="{{route('updatepermission')}}" method="POST" id="editRoleForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <button onclick="editRole()" type="submit" class="btn btn-md btn-success save" style="width:100%;margin-bottom: 10px">{{Translate('حفظ')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
