...
@section('title') الاطباء @endsection
@section('style')
    ...
    <div class="modal fade" id="add-user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('addsaler')}}" id="addUserForm" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal fade" id="edit-user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('updatesaler')}}" id="updateUserForm" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('deletesaler')}}" method="post" class="d-flex align-items-center">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('deletesalers')}}" method="post" class="d-flex align-items-center">
                        @csrf
...
@section('script')
    <script>
        function sortedByData(){
            ...
            window.location.assign('salers?name=' + sortedByName + '&phone=' + sortedByPhone + '&email=' + sortedByEmail);
        }
