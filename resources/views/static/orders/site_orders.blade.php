                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <div class="btn-action">
                                            <a href="{{route('site_showorder' , $item->id)}}" class="btn btn-primary btn-sm" title="{{Translate('عرض')}}">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('site_updatedata_order')}}" id="addAdminForm" method="POST" enctype="multipart/form-data">
                @csrf
...
@section('script')
    <script>
        ...
        function sortedBy(){
            ...
            let href        = '{{route('site_show_orders')}}' + '?' + querystring;
