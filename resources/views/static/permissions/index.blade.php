...
@section('title') {{Translate('الصلاحيات')}} @endsection
@section('style')
            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="btns header-buttons">
                        <button class="btn bg-teal" title="{{Translate('اضافة')}}" onclick="addRole()">
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <div class="btn-action">
                                            @if($item->id != 1)
                                                <a href="{{url('edit-page-permission/' . $item->id)}}" class="btn btn-sm bg-teal" title="{{Translate('تعديل')}}">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a href="#" class="btn btn-sm btn-danger" title="{{Translate('حذف')}}" onclick="deletePermission('{{ $item->id }}')"  data-toggle="modal" data-target="#confirm-del">
