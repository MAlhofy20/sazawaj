...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card" style="width:100% !important;">
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{route('site_post_lab_profile')}}" id="profileForm" method="post" autocomplete="off" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <h3>{{Translate('انواع الفحص')}}</h3>
                            </div>
                        </div>
                        <div class="row types">
                            @if(Auth::user()->checks->count() > 0)
                                @foreach (Auth::user()->checks as $key=>$item)
                                    <div class="col-xs-12 col-md-4">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">عنوان الفحص بالعربية </label>
                                            <input type="text" autocomplete="nope" name="titles_ar[{{$key}}]" value="{{$item->title_ar}}" required class="form-control" placeholder="عنوان الفحص بالعربية ">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-4">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">عنوان الفحص بالانجليزية </label>
                                            <input type="text" autocomplete="nope" name="titles_en[{{$key}}]" value="{{$item->title_en}}" required class="form-control" placeholder="عنوان الفحص بالانجليزية ">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-4">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">رسوم الحجز </label>
                            ...
                            @else
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label">عنوان الفحص بالعربية </label>
                                        <input type="text" autocomplete="nope" name="titles_ar[0]" value="" required class="form-control" placeholder="عنوان الفحص بالعربية ">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label">عنوان الفحص بالانجليزية </label>
                                        <input type="text" autocomplete="nope" name="titles_en[0]" value="" required class="form-control" placeholder="عنوان الفحص بالانجليزية ">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label">رسوم الحجز </label>
                                        <input type="text" autocomplete="nope" name="prices[0]" value="" required class="form-control phone" placeholder="رسوم الحجز">
                                    </div>
                                </div>
                            @endif
                        </div>
...
@section('script')
    <script>
        ...
        function site_post_profile() {
            ...
            $.ajax({
                type        : 'POST',
                url         : '{{ route('site_post_lab_profile') }}' ,
                datatype    : 'json' ,
                async       : false,
                processData : false,
                contentType : false,
